        ...
        <div>
          ...
          <div className="space-y-4">
            <div className="bg-foreground/5 rounded-lg p-6">
              ...
              <p className="text-foreground/80">
                A beautiful portfolio website built with Next.js and Tailwind CSS. Scroll down to
                see the custom footer with multiple columns.
              </p>
            </div>
          </div>
        </div>
...
// Legacy Layout stories for backward compatibility
export const LegacyDefault: Story = {
  render: () => (
    <LegacyLayout title="Blog">
      <div>
        <h1 className="mb-4 text-3xl font-bold">Legacy Layout Example</h1>
        <p className="text-foreground/70 mb-4">
          This uses the deprecated Layout component for backward compatibility.
        </p>
      </div>
    </LegacyLayout>
  ),
